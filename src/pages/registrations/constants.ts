...
export const REGISTRATION_CHANNELS: RegistrationChannel[] = [
  {
    ...
    description: 'Students who completed admission and have paid at least 25% tuition (UTME, Direct Entry, and Transfer).',
  ...
  },
  {
    ...
    description: 'JUPEB students who completed admission and have paid at least 25% tuition.',
    entryModes: ['jupeb'],
    showEntryMode: false,
  },
  {
    ...
    description: 'Postgraduate students who completed admission and have paid at least 25% tuition.',
    entryModes: ['pg'],
    showEntryMode: false,
  },
];
