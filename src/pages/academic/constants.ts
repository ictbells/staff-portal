...
export const RESULTS_RESOURCES: AcademicResource[] = [
  ...
  { key: 'results-department', path: '/academic/results/department', label: 'Department', perm: 'results.department_submit' },
  { key: 'results-college', path: '/academic/results/college', label: 'College', perm: 'results.submit' },
